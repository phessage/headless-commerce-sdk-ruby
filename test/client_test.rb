...
class ClientTest < Minitest::Test
  ...
  def test_reads_retry_and_raise_typed_problem
    attempts = 0; transport = ->(*) { attempts += 1; attempts == 1 ? [503, '{}', { 'Retry-After' => '0' }] : [404, '{"type":"x","title":"Missing","requestId":"body-id"}', { 'X-Request-Id' => 'header-id', 'RateLimit-Limit' => '100', 'RateLimit-Remaining' => '0', 'RateLimit-Reset' => '42', 'Retry-After' => '7' }] }
